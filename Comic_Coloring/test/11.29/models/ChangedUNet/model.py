...
class ChangedUNetG(Model):
    ...
    def __init__(self, star_channel=64, out_channel=3, mid_channel_scale=0.5,
        ...
        self.up4 = Up(star_channel, groups=groups, scale=2, leaky_relu_alpha=leaky_relu_alpha)

        # out
        self.out_conv = Conv2D(out_channel, kernel_size=1, padding='same', use_bias=False, activation='tanh')
